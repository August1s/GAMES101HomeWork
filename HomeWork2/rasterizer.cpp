...
//    Vector3f v01, v12, v20, p0, p1, p2;
//    v01 = Vector3f(_v[1].x() - _v[0].x(), _v[1].y() - _v[0].y(), 0);
//    v12 = Vector3f(_v[2].x() - _v[1].x(), _v[2].y() - _v[1].y(), 0);
//    v20 = Vector3f(_v[0].x() - _v[2].x(), _v[0].y() - _v[2].y(), 0);
//    
//    Vector3f point = Vector3f(x, y, 0);
//    p0 = Vector3f(point.x() - _v[0].x(), point.y() - _v[0].y(), 0);
...
void rst::rasterizer::rasterize_triangle(const Triangle& t) {
    ...
    int left, right, top, bottom; // 假设坐标系原点在左下方,浮点数四舍五入
